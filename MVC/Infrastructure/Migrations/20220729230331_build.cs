        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePath = table.Column<string>(type: "nvarchar(128)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleaseDate = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
                    RunTime = table.Column<int>(type: "int", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LockoutEndDate = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
                    LastloginDateTime = table.Column<DateTime>(type: "datetime2(7)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipper_Category_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Department = table.Column<string>(type: "nvarchar(128)", nullable: false),
                    Job = table.Column<string>(type: "nvarchar(128)", nullable: false)
                },
                constraints: table =>
                {
